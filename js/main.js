...
// Aplicar configurações específicas quando executado como PWA
if (isRunningAsInstalledPwa()) {
    console.log('Aplicativo executando como PWA instalado');
    
    // Aplicar altura total a toda a página quando instalado
    document.documentElement.style.height = '100%';
    document.body.style.height = '100%';
    document.body.style.overflow = 'hidden';
    
    // Impedir que a barra do navegador apareça no iOS
